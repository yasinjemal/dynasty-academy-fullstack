...
async function testIntelligentAudio() {
  try {
    console.log(
      "📝 Test Case: Chapter narration with semantic understanding\n"
    );
    ...
    console.log(
      `   • Semantic Cache Hit: ${
        result.intelligenceMetrics.semanticCacheHit ? "✅ YES" : "❌ NO"
      }`
    );
    console.log(
      `   • Cache Hit Rate: ${(
        result.intelligenceMetrics.cacheHitRate * 100
      ).toFixed(1)}%`
    );
    console.log(
      `   • Voice Match Score: ${(
        result.intelligenceMetrics.voiceMatchScore * 100
      ).toFixed(1)}%`
    );
    console.log(
      `   • Predicted Next: ${
        result.intelligenceMetrics.predictedNext?.length || 0
      } chapters`
    );
    console.log(
      `   • Quality Score: ${(
        result.intelligenceMetrics.qualityScore * 100
      ).toFixed(1)}%`
    );
    ...
    console.log(
      `   • Emotional Tone: ${(
        result.intelligenceMetrics.emotionalTone * 100
      ).toFixed(0)}%`
    );
    console.log(
      `   • Complexity: ${(result.intelligenceMetrics.complexity * 100).toFixed(
        0
      )}%`
    );
    console.log(
      `   • Target Audience: ${result.intelligenceMetrics.targetAudience}`
    );
    console.log(
      `   • Key Themes: ${result.intelligenceMetrics.keyThemes.join(", ")}\n`
    );

    console.log("⚡ Performance:");
    console.log(
      `   • Processing Time: ${result.intelligenceMetrics.processingTime}ms`
    );
    console.log(
      `   • Cache Efficiency: ${
        result.intelligenceMetrics.cacheHit
          ? "Instant delivery"
          : "Generated + cached for future"
      }\n`
    );
    ...
    console.log(
      "    → Classified as narrative, emotional tone 0.65, complexity 0.45\n"
    );
    ...
    console.log(
      '    → Would match "Chapter One" to "Chapter 1" (same meaning)\n'
    );
    ...
    console.log(
      "    → Predicted user will read Chapter 2-3 next (87% accuracy)"
    );

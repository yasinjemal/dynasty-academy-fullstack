  ...
  return (
    ...
    >
      ...
      {plan.popular && (
        ...
        >
          <div className={`bg-gradient-to-r ${plan.gradient} px-4 py-1.5 rounded-full text-xs font-bold text-white shadow-lg flex items-center gap-1`}>
      ...
      {/* Card */}
      <div className={`relative backdrop-blur-xl bg-white/5 border-2 ${
        ...
        >
          <div className="w-full h-full bg-[#0A0E27] rounded-2xl flex items-center justify-center">
            <Icon className={`w-8 h-8 bg-gradient-to-br ${plan.gradient} bg-clip-text text-transparent`} />
          </div>
        </motion.div>

      ...
      <div className="relative z-10 p-6 md:p-8 lg:p-10">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <p className="text-white/60 text-sm">To Next Level</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-sm rounded-2xl p-4 border border-orange-500/30"
          >
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-sm rounded-2xl p-4 border border-blue-500/30"
          >
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-blue-300/60 text-xs">Completed</p>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-sm rounded-2xl p-4 border border-purple-500/30"
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <div>
                <p className="text-purple-200 text-xs">Books</p>
                <p className="text-white text-2xl font-bold">
                  {stats.booksOwned}
                </p>
              </div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-yellow-500/20 to-amber-500/20 backdrop-blur-sm rounded-2xl p-4 border border-yellow-500/30"
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <div>
                <p className="text-yellow-200 text-xs">Certificates</p>
                <p className="text-white text-2xl font-bold">
                  {stats.certificatesEarned}
                </p>
              </div>
            </div>
            <p className="text-yellow-300/60 text-xs">Earned</p>
          </motion.div>
        </div>
        ...
        {stats.duelsPlayed > 0 && (
          <motion.div
            ...
            className="mt-4 bg-gradient-to-r from-pink-500/20 to-purple-500/20 backdrop-blur-sm rounded-2xl p-4 border border-pink-500/30"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-pink-200 text-xs">Duels Performance</p>
                  <p className="text-white text-xl font-bold">
                    {stats.duelsWon} Wins / {stats.duelsPlayed} Played
                  </p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-pink-200 text-xs">Win Rate</p>
                <p className="text-white text-xl font-bold">
                  {stats.duelsPlayed > 0

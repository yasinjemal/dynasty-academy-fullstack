...
export default function AdminBooksPage() {
  ...
  const handleAIAnalysisComplete = (analysis: any) => {
    ...
    setFormData({
      ...
      // You could also store metaTitle/metaDescription if your schema supports them
    });
  };
    ...
    <div className="p-4 sm:p-6 md:p-8">
      ...
      {alert && (
        <div className="fixed top-4 right-4 z-50 animate-fade-in">
          <div
            className={`rounded-lg shadow-xl p-4 min-w-[300px] ${
              alert.type === "error"
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                      💡 After creating the book, use the "📖 Manage" button to
                      upload the book file (PDF, DOCX, MD, or TXT)
                    </p>
                  </div>
                </div>

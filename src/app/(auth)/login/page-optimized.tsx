          ...
          <div className="hidden lg:block space-y-6">
            <div>
              ...
              <p className="text-lg lg:text-xl text-white/60 leading-relaxed">
                Access your personalized library, track progress, and unlock
                achievements
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "50+ books ready to read",
                  gradient: "from-blue-500 to-cyan-500",
                },
                {
                  icon: Trophy,
                  title: "Track Your Progress",
                  desc: "See your reading streaks",
                ...
                },
                {
                  ...
                  desc: "Premium early access",
                  gradient: "from-emerald-500 to-teal-500",
                },
              ].map((benefit, i) => (
                <div
                  key={i}
                  className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-4 flex items-center gap-4 hover:bg-white/[0.07] transition-colors"
                >
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-br ${benefit.gradient} flex items-center justify-center flex-shrink-0 shadow-lg`}
                  >
              ...
              <div className="relative backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 shadow-2xl">
                ...
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="px-4 text-white/40 bg-[#0A0E27]">
                      OR CONTINUE WITH
                    </span>
                  </div>
                </div>

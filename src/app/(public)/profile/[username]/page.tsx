...
import AchievementShowcase, { sampleAchievements } from "@/components/profile/AchievementShowcase";
import ComparisonStats from "@/components/profile/ComparisonStats";
import DailyChallenges, { sampleChallenges } from "@/components/profile/DailyChallenges";
import PowerUpsSystem, { samplePowerUps, sampleEvents } from "@/components/profile/PowerUpsSystem";
import ProfileVisitors, { sampleVisitors } from "@/components/profile/ProfileVisitors";
...
export default async function ProfilePage({
  ...
  const comparisonStats = [
    { label: 'Dynasty Score', current: user.dynastyScore, previous: user.dynastyScore - 250, unit: 'pts', icon: TrendingUp },
    { label: 'Books Read', current: user.booksCompleted, previous: user.booksCompleted - 2, unit: 'books', icon: BookOpen },
    { label: 'Reading Time', current: user.readingMinutesLifetime, previous: user.readingMinutesLifetime - 120, unit: 'min', icon: Clock },
    { label: 'Followers', current: user.followersCount, previous: user.followersCount - 15, unit: 'people', icon: Users },
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <CelebrationTrigger type="streak" trigger={user.streakDays > 0 && user.streakDays % 7 === 0} emoji="🔥" />

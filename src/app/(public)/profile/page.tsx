...
import DynastyPointsCard from '@/components/profile/DynastyPointsCard'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 dark:from-gray-900 dark:via-purple-900/30 dark:to-blue-900/30">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        {/* Dynasty Points & Rewards Section */}
        <div className="mb-8">
          <DynastyPointsCard userId={session.user.id} />
        </div>

        {/* Share Your Profile - NEW */}
        <div className="mb-8">
          <Card className="border-0 shadow-xl bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 p-1">
            <div className="bg-white dark:bg-gray-900 rounded-lg p-6">
              <div className="flex items-center justify-between">
                ...
                <Link href={`/@${(session.user.name || '').toLowerCase().replace(/\s+/g, '-')}`} target="_blank">
              ...
              <div className="mt-4 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                <div className="flex items-center justify-between gap-3">
                  <code className="text-sm text-purple-800 dark:text-purple-300 font-mono flex-1">
                    {typeof window !== 'undefined' ? window.location.origin : 'https://dynastybuilt.com'}/@{(session.user.name || '').toLowerCase().replace(/\s+/g, '-')}
                  </code>
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => {
                      ...
                      const url = `${typeof window !== 'undefined' ? window.location.origin : 'https://dynastybuilt.com'}/@${urlFriendlyUsername}`

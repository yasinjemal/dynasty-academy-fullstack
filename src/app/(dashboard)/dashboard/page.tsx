    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 via-blue-600 to-purple-800">
        <div className="text-center">
          ...
          <p className="mt-6 text-white text-lg font-medium">Loading your dashboard...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <div className="flex items-center gap-1 sm:gap-2 md:gap-3">
              <Link href="/books"><Button variant="ghost" size="sm" className="text-xs sm:text-sm">📚 Books</Button></Link>
              <Link href="/blog"><Button variant="ghost" size="sm" className="text-xs sm:text-sm">✍️ Blog</Button></Link>
              <Link href="/achievements" className="hidden sm:block"><Button variant="ghost" size="sm">🏆</Button></Link>
          ...
          <div className="group relative bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden transform hover:-translate-y-2 hover:scale-[1.02]">
            ...
            <div className="relative p-5 sm:p-6 md:p-7 lg:p-8">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs md:text-sm text-white/80 font-medium">This Month</span>
              </div>
              <p className="text-white/90 text-sm md:text-base font-medium mb-2">Total Books</p>
          ...
          <div className="group relative bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden transform hover:-translate-y-2 hover:scale-[1.02]">
            ...
            <div className="relative p-5 sm:p-6 md:p-7 lg:p-8">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs md:text-sm text-white/80 font-medium">Published</span>
              </div>
              <p className="text-white/90 text-sm md:text-base font-medium mb-2">Blog Posts</p>
              <p className="text-4xl md:text-5xl font-bold text-white mb-2">0</p>
              <div className="flex items-center text-white/80 text-xs md:text-sm">
                <span className="flex items-center">
                  <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="group relative bg-gradient-to-br from-green-500 to-emerald-700 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden transform hover:-translate-y-2 hover:scale-[1.02] sm:col-span-2 lg:col-span-1">
            ...
            <div className="relative p-5 sm:p-6 md:p-7 lg:p-8">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs md:text-sm text-white/80 font-medium">Completed</span>
              </div>
              <p className="text-white/90 text-sm md:text-base font-medium mb-2">Orders</p>
              <p className="text-4xl md:text-5xl font-bold text-white mb-2">0</p>
              <div className="flex items-center text-white/80 text-xs md:text-sm">
                <span className="flex items-center">
                  <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
            ...
            <Link href="/books" className="group relative bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 rounded-xl p-4 sm:p-5 md:p-6 hover:shadow-lg hover:shadow-purple-200/50 dark:hover:shadow-purple-900/50 transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] border border-purple-200/50 dark:border-purple-700/50">
              <div className="flex flex-col items-center text-center space-y-2 sm:space-y-3">
                <div className="p-2 sm:p-3 bg-purple-200/50 dark:bg-purple-700/50 rounded-xl group-hover:scale-110 group-hover:rotate-3 transition-transform">
                  <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-purple-600 dark:text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                  </svg>
                </div>
                <span className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base">Browse Books</span>
              </div>
            </Link>

            <Link href="/blog" className="group relative bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-xl p-4 sm:p-5 md:p-6 hover:shadow-lg hover:shadow-blue-200/50 dark:hover:shadow-blue-900/50 transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] border border-blue-200/50 dark:border-blue-700/50">
              <div className="flex flex-col items-center text-center space-y-2 sm:space-y-3">
                <div className="p-2 sm:p-3 bg-blue-200/50 dark:bg-blue-700/50 rounded-xl group-hover:scale-110 group-hover:rotate-3 transition-transform">
                  <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-blue-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
                  </svg>
                </div>
                <span className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base">Read Blog</span>
              </div>
            </Link>

            <Link href="/achievements" className="group relative bg-gradient-to-br from-yellow-50 to-amber-100 dark:from-yellow-900/30 dark:to-amber-800/30 rounded-xl p-4 sm:p-5 md:p-6 hover:shadow-lg hover:shadow-yellow-200/50 dark:hover:shadow-yellow-900/50 transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] border border-yellow-200/50 dark:border-yellow-700/50">
              <div className="flex flex-col items-center text-center space-y-2 sm:space-y-3">
                <div className="p-2 sm:p-3 bg-yellow-200/50 dark:bg-yellow-700/50 rounded-xl group-hover:scale-110 group-hover:rotate-3 transition-transform">
                  <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-yellow-600 dark:text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                  </svg>
                </div>
                <span className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base">Achievements</span>
              </div>
            </Link>
            ...
            <Link href="/leaderboard" className="group relative bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/30 dark:to-emerald-800/30 rounded-xl p-4 sm:p-5 md:p-6 hover:shadow-lg hover:shadow-green-200/50 dark:hover:shadow-green-900/50 transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] border border-green-200/50 dark:border-green-700/50">
              <div className="flex flex-col items-center text-center space-y-2 sm:space-y-3">
                <div className="p-2 sm:p-3 bg-green-200/50 dark:bg-green-700/50 rounded-xl group-hover:scale-110 group-hover:rotate-3 transition-transform">
                  <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-green-600 dark:text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                </div>
                <span className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base">Leaderboard</span>
              </div>
            </Link>
          </div>
            ...
            {session.user?.role === 'ADMIN' ? (
              <Link href="/admin/blog">
                <button className="group relative w-full bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 hover:from-purple-700 hover:via-blue-700 hover:to-purple-700 text-white rounded-xl p-6 transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] shadow-lg hover:shadow-2xl hover:shadow-purple-500/50 overflow-hidden">
                  ...
                  <div className="absolute inset-0 opacity-30">
                    <div className="absolute top-0 left-0 w-64 h-64 bg-white rounded-full blur-3xl animate-pulse" />
                    <div className="absolute bottom-0 right-0 w-64 h-64 bg-yellow-400 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
                  </div>
                  ...
                  <div className="relative z-10 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        <p className="text-xl sm:text-2xl font-bold">✍️ Write a Blog Post</p>
                        <p className="text-sm text-white/80 mt-1">Share your knowledge and insights with the community</p>
                      </div>
                    </div>
                    <svg className="w-6 h-6 group-hover:translate-x-2 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                ...
                <button className="group relative w-full bg-gradient-to-r from-green-500 via-emerald-600 to-teal-600 hover:from-green-600 hover:via-emerald-700 hover:to-teal-700 text-white rounded-xl p-6 transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] shadow-lg hover:shadow-2xl hover:shadow-green-500/50 overflow-hidden">
                  ...
                  <div className="relative z-10 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        <p className="text-xl sm:text-2xl font-bold">🌟 Join the Community</p>
                        <p className="text-sm text-white/80 mt-1">Share ideas, ask questions, and connect with fellow learners</p>
                      </div>
                    </div>
                    <svg className="w-6 h-6 group-hover:translate-x-2 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
        ...
        <div className="bg-gradient-to-br from-white to-purple-50 dark:from-gray-900 dark:to-purple-900/20 backdrop-blur-xl rounded-2xl shadow-xl p-5 sm:p-6 md:p-7 lg:p-8 border border-purple-200/50 dark:border-purple-800/50">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
            ...
            <div className="flex-1">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Account Information</h2>
              <p className="text-xs sm:text-sm md:text-base text-gray-600 dark:text-gray-400 mt-1">Manage your profile and preferences</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-5">
            <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-4 sm:p-5 border border-purple-100 dark:border-purple-800/30 hover:shadow-md transition-shadow">
              <p className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Full Name</p>
              <p className="text-sm sm:text-base md:text-lg font-bold text-gray-900 dark:text-white">{session.user?.name}</p>
            </div>
            
            <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-4 sm:p-5 border border-purple-100 dark:border-purple-800/30 hover:shadow-md transition-shadow">
              <p className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Email Address</p>
              <p className="text-sm sm:text-base md:text-lg font-bold text-gray-900 dark:text-white truncate" title={session.user?.email || ''}>{session.user?.email}</p>
            </div>
            
            <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-4 sm:p-5 border border-purple-100 dark:border-purple-800/30 hover:shadow-md transition-shadow">
              <p className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Account Role</p>
              <span className={`inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-bold ${
                session.user?.role === 'ADMIN' 
            ...
            <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-4 sm:p-5 border border-purple-100 dark:border-purple-800/30 hover:shadow-md transition-shadow">
              <p className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Member Since</p>
          ...
          <div className="mt-5 sm:mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            {session.user?.role === 'ADMIN' && (
              <Link href="/admin" className="flex-1">
                <Button variant="outline" className="w-full border-2 border-purple-600 text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/30 font-semibold py-5 sm:py-6 rounded-xl hover:scale-[1.02] transition-all text-sm sm:text-base">
                  👑 Admin Panel
                </Button>
              </Link>
            )}

            ...
            {activeTab === "overview" && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <motion.button
                    whileTap={{ scale: 0.95 }}
                    className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-4 flex items-center justify-center gap-2 text-white font-semibold shadow-lg shadow-purple-500/30"
                  >
                  ...
                  <motion.button
                    whileTap={{ scale: 0.95 }}
                    className="bg-gradient-to-r from-pink-600 to-purple-600 rounded-2xl p-4 flex items-center justify-center gap-2 text-white font-semibold shadow-lg shadow-pink-500/30"
                  >
